...
public class WorldStatus {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("<pre>" + worldRegistry.getStatus() + "</pre>");
		} catch (Exception e) {
			System.out.println("<span style=\"color: red\"><strong>The OdinMS game servers are currently unavailable. Please come back in a few hours.</strong></span>");
		}
	}
